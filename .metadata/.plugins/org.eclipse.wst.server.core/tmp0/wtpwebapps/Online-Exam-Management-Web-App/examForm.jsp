      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <form action="ExamInsertServlet" method="POST" id="exam-form" onsubmit="return validateForm()">
           ...
           <tr>
            <div class="mb-3">
             <td><label for="exam-title" class="form-label">Exam Title</label></td>
              <td><input
                type="text"
                class="form-control"
                id="exam-title"
            ...
            <tr>
            <div class="mb-3">
              <td><label for="exam-duration" class="form-label">Exam Duration</label></td>
              <td><input
                type="number"
                class="form-control"
                id="exam-duration"
            ...
            <tr>
            <div class="mb-3">
              <td><label for="num-participants" class="form-label">Number of Participants</label></td>
              <td><input
                type="number"
                class="form-control"
                id="num-participants"
            ...
            <tr>
            <div class="mb-3">
              <td><label for="num-questions" class="form-label">Number of Questions</label></td>
              <td><input
                type="number"
                class="form-control"
                id="num-questions"
            ...
            <tr>
            <div class="mb-3">
              <td><label for="num-questions" class="form-label">Quiz Password</label></td>
              <td><input
                type="text"
                class="form-control"
                id="q-password"
